...
export default function Newsletter() {
    ...
    return (
        <section id="newsletter" className="py-20 px-6 bg-grey">
            <div className="max-w-3xl mx-auto text-center">
                <motion.div
                    ...
                    className="bg-white rounded-3xl p-12 shadow-sm border border-navy/5 relative overflow-hidden"
                >
                    ...
                    <div className="relative z-10">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-teal/10 text-teal text-sm font-semibold mb-5">
                            <Sparkles size={14} />
                            Stay Updated
                        </div>
                        ...
                        {subscribed ? (
                            ...
                            >
                                ...
                                <p className="text-navy/50 text-sm">Welcome to the NIAMBIO community.</p>
                            </motion.div>
                        ) : (
                            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
                                <input
                                    ...
                                    className="flex-1 px-5 py-3.5 rounded-full border-2 border-navy/10 outline-none focus:border-teal transition-colors text-navy bg-grey placeholder:text-navy/30 text-sm"
                                />
